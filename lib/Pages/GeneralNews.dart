...
import 'package:newz/Backend/fetchGeneralnews.dart';
...
class GeneralNews extends StatefulWidget {
  static const String id = 'GeneralNews';
      ...
      appBar: AppBar(
        ...
        title: Container(
          child: Row(
            ...
            children: [
              boldText(text: 'GENERAL', color: AppColors.primary, size: 20),
