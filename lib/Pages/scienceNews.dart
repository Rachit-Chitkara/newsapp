...
import 'package:newz/Backend/fetchSciencenews.dart';
...
class ScienceNews extends StatefulWidget {
  static const String id = 'ScienceNews';
      ...
      appBar: AppBar(
        ...
        title: Container(
          child: Row(
            ...
            children: [
              boldText(text: 'SCIENCE', color: AppColors.primary, size: 20),
